...
When you build your project (see [below](#building_the_project)), you should find a new script at the path you specified as your `output` parameter. (This script should most likely be the file named in the `"main"` property inside the project's package.json file.) Its contents will look something like this:
